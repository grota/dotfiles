...
[core]
s0_active_plugins = core;composite;opengl;snap;move;compiztoolbox;regex;resize;place;session;neg;wall;commands;copytex;imgpng;mousepoll;grid;animation;vpswitch;unitymtgrabhandles;workarounds;expo;ezoom;staticswitcher;fade;scale;unityshell;addhelper;
